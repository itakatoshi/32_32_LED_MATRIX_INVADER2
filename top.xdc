...
set_property -dict {PACKAGE_PIN L3 IOSTANDARD LVCMOS33} [get_ports STB]
set_property -dict {PACKAGE_PIN A16 IOSTANDARD LVCMOS33} [get_ports {sel_ABCD[3]}]
set_property -dict {PACKAGE_PIN K3 IOSTANDARD LVCMOS33} [get_ports {sel_ABCD[1]}]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pio[05] }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]
set_property -dict {PACKAGE_PIN H1 IOSTANDARD LVCMOS33} [get_ports G1]
#set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { pio[07] }]; #IO_L6N_T0_VREF_16 Sch=pio[07]
set_property -dict {PACKAGE_PIN B15 IOSTANDARD LVCMOS33} [get_ports G0]
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { sound_out  }]; #IO_L6P_T0_16 Sch=pio[09]
...
set_property -dict { PACKAGE_PIN V4    IOSTANDARD LVCMOS33 } [get_ports  sw3 ]; #IO_L11N_T1_SRCC_34 Sch=pio[37]
set_property -dict { PACKAGE_PIN U4    IOSTANDARD LVCMOS33 } [get_ports  sw2 ]; #IO_L11P_T1_SRCC_34 Sch=pio[38]
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports  sw1 ]; #IO_L16N_T2_34 Sch=pio[39]
set_property -dict { PACKAGE_PIN W4    IOSTANDARD LVCMOS33 } [get_ports  sw0 ]; #IO_L12N_T1_MRCC_34 Sch=pio[40]
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports R0]
set_property -dict {PACKAGE_PIN U2 IOSTANDARD LVCMOS33} [get_ports B0]
set_property -dict {PACKAGE_PIN W6 IOSTANDARD LVCMOS33} [get_ports R1]
set_property -dict {PACKAGE_PIN U3 IOSTANDARD LVCMOS33} [get_ports B1]
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports {sel_ABCD[2]}]
set_property -dict {PACKAGE_PIN W7 IOSTANDARD LVCMOS33} [get_ports {sel_ABCD[0]}]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports LED_CLK]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports OE]
